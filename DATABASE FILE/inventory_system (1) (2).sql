...
(7, 'Reynolds', 'Okyere', '2024-07-03', 'Male', 22.00, 22.00, 22, 22.00, 454.55, 'judercio.nhauche@ashesi.edu.gh');
...
INSERT INTO `prescriptions` (`id`, `date`, `medicine_id`, `patient_id`, `patient_name`, `dosage`, `number_of_days`, `frequency`, `route`, `instructions`, `pharma_id`) VALUES
(1, '2024-07-30 14:56:15', 39, 5, 'Judercio', '10', 5, 'everyday', 'oral', '2 days a century', 37),
(2, '2024-07-30 14:58:09', 40, 7, 'Reynolds Okyere', '10', 4, 'everyday', 'oral', 'take sleep', 37),
(3, '2024-07-30 21:32:59', 39, 6, 'Judercio James', '10', 2, 'everyday', 'buccal', 'keep quiet', 37),
(4, '2024-07-30 21:45:36', 41, 5, 'Judercio Nhauche', '10', 2, 'everyday', 'intravenous', 'more weak', 37);
...
(39, 'Acetaminophen', 43, 2, 3, '2024-07-28 20:09:30', '0319810001818', 'Excedrin', 34),
(40, 'Veracide', 100, 3, 4, '2024-07-30 20:36:22', '000000000000000', 'Omo', 36),
(41, 'Castor Oil', 100, 4, 4, '2024-07-30 21:40:21', '0318858501328', 'Flamingo', NULL);
...
(37, 'Rey', 'Reyy', 'Reyy', '683772ebbfd1630f936bf8c5c49b4d8d9d44a2da', 2, 'no_image.jpg', 1, '2024-07-30 14:11:28');
...
ALTER TABLE `prescriptions`
  ...
  ADD CONSTRAINT `prescriptions_ibfk_2` FOREIGN KEY (`pharma_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `prescriptions_ibfk_3` FOREIGN KEY (`medicine_id`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
